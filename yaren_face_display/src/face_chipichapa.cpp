    ...
    VideoSynchronizer() : Node("face_screen") {
        ...
        if (SDL_Init(SDL_INIT_AUDIO) < 0) {
            ...
            if (Mix_OpenAudio(44100, MIX_DEFAULT_FORMAT, 2, 2048) < 0) {
                ...
                std::string rutaMusica = "/home/roberto/robotis_ws/src/YAREN2/yaren_radio/audios/Chipi chipi chapa chapa dubi dubi daba daba Christell - Dubidubidu Subtitulada en español.mp3";
