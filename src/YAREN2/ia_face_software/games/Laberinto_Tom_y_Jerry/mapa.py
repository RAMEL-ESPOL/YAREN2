...
class Mapa:
    def __init__(self, archivo):
        ...
        self.h=pygame.image.load(current_dir+'h.png').convert_alpha()
        self.v=pygame.image.load(current_dir+'v.png').convert_alpha()
        self.sd=pygame.image.load(current_dir+'sd.png').convert_alpha()
        self.id=pygame.image.load(current_dir+'id.png').convert_alpha()
        self.ii=pygame.image.load(current_dir+'ii.png').convert_alpha()
        self.si=pygame.image.load(current_dir+'si.png').convert_alpha()
        self.q=pygame.image.load(current_dir+'q.png').convert_alpha() 
