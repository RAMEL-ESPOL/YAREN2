...
class FacialExpressionModel(object):
    ...
    def predict_emotion(self, img):
        ...
        self.preds = self.interpreter.get_tensor(self.output_details[0]['index'])
...
class EmotionDetectionNode(Node):
    def __init__(self):
        ...
        model_path = os.path.join(pkg_path, 'models', 'model_mbn_1.tflite')

        self.interpreter = tf.lite.Interpreter(model_path=model_path)
        self.emotion_model = FacialExpressionModel(self.interpreter)
